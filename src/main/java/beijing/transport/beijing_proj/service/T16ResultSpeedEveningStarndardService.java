...
/**
 * <p>
 * 指标6计算结果：晚高峰公交站间速度可靠性 服务类
 * </p>
 *
 * @author Jinglin
 * @since 2022-11-07
 */
public interface T16ResultSpeedEveningStarndardService extends IService<T16ResultSpeedEveningStarndard> {
    /**
     * 筛选查询
     *
     * @param queryDTO
     * @return
     */
    T16EveningStandardResultReturn query(QueryDTO queryDTO);
     ...
     * @return
     */
    List<T16ResultSpeedEveningStarndard> queryAll();
